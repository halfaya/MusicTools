...
open import Data.List       public using (List; []; _∷_; _∷ʳ_; foldl; map; reverse; length; _++_; take; drop; concat; zip; replicate; sum)
open import Data.Maybe      public using (Maybe; just; nothing)
open import Data.Nat        public using (ℕ; zero; suc; pred; _+_; _*_; _<ᵇ_; _≤ᵇ_; _<?_; _≟_; _∸_; _<_; s≤s; z≤n; _⊓_; _⊔_; ⌊_/2⌋) renaming (_≡ᵇ_ to _==_)
