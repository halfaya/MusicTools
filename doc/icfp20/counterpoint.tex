...
\newcommand{\Motion}{
  \begin{figure}
    \includegraphics[width=7cm]{fig/motion1.png}
    \hspace{8mm}
    \includegraphics[width=3.35cm]{fig/motion2.png}
    \begin{flushleft}
    \begin{small}
      \hspace{1.55cm} contrary \ \ \ \ \ \ \ \ parallel \ \ \ \ \ \ \
      \ \ \,similar \ \ \ \ \ \ \ \ \ oblique
      \hspace{1.3cm} paralell-5th \ \ \ similar-8th
    \end{small}
    \end{flushleft}
    \caption{Four Kinds of Motion (left) and Invalid Patterns (right)}
    \Description{Four Kinds of Motion (left) and Invalid Patterns (right)}
    \label{fig:motion}
  \end{figure}
}
