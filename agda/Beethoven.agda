...
beethoven146v : Vec (Vec SPitch 12) 4
beethoven146v =
...
beethoven146sa : List (SPitch × SPitch)
beethoven146sa =
   (G 4 , C 5) ∷
   (C 5 , E 5) ∷
   (B 4 , G 5) ∷
...
-- Haydn's correction
beethoven146h : List (SPitch × SPitch)
beethoven146h =
   (G 4 , C 5) ∷
   (C 5 , E 5) ∷
   (B 4 , G 5) ∷
...
beethoven146-1 : List (SPitch × SPitch)
beethoven146-1 =
   (G 4    , C 5) ∷
   (C 5    , E 5) ∷
   (B 4    , G 5) ∷
...
beethoven146-3 : List (SPitch × SPitch)
beethoven146-3 =
   (G 4     , C 5) ∷
   (C 5     , E 5) ∷
   (B 4     , G 5) ∷
...
beethoven146cf : List (SPitch × SPitch)
beethoven146cf =
   (G 4      , C 5) ∷
   (?? "?1"  , E 5) ∷
   (?? "?2"  , G 5) ∷
